...
/**
 * Returns the full AGENTS.md prompt content for AAF annotation.
 */
...
/**
 * Returns a concise set of rules for AAF annotation.
 */
...
/**
 * Validates an action name follows AAF conventions.
 */
...
/**
 * Validates a field name follows AAF conventions.
 */
